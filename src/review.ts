...
const ignoreKeyword = '@PrimathonAICodeReviewer: ignore'
...
<details>
<summary>Uplevel your code reviews with PrimathonAICodeReviewer Pro</summary>

### PrimathonAICodeReviewer Pro

If you like this project, please support us by purchasing the [Pro version](https://primathon.in). The Pro version has advanced context, superior noise reduction and several proprietary improvements compared to the open source version. Moreover, PrimathonAICodeReviewer Pro is free for open source projects.
...
### Chat with <img src="https://avatars.githubusercontent.com/u/135949086?s=41&u=9d633d9b9a7e72aa56bb997a6e8d231e73c3879a&v=4" alt="Image description" width="20" height="20">  PrimathonAICodeReviewer Bot (\`@PrimathonAICodeReviewer\`)
- Reply on review comments left by this bot to ask follow-up questions. A review comment is a comment on a diff or a file.
- Invite the bot into a review comment chain by tagging \`@PrimathonAICodeReviewer\` in a reply.
...
- Add \`@PrimathonAICodeReviewer: ignore\` anywhere in the PR description to pause further reviews from the bot.
